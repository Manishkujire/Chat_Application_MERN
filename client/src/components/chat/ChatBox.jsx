            ...
            {recipientUser && (
                ...
                <Stack gap={4} className='chat-box'>
                    ...
                    <Stack direction='horizontal' gap={1} className='chat-input flex-grow-0'>
                        ...
                        <button onClick={()=>sendTextMessage(textMessage,user?._id,currentChat?._id,setTextMessage)} className='send-btn'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-send" viewBox="0 0 16 16">
